...
class ForceHome extends Component {
  ...
  simulation = d3.forceSimulation()
              ...
              .force("x", d3.forceX().strength(0.1).x(d => this.xScale(d.female/d.total)) )
  ...
  initSim() {
    ...
    this.simulation.nodes(this.state.schools)
  ...
  render() {
    return (
      <canvas width={ width } height={ height } ref="homeCanvas" ></canvas>
    )
  }
}
